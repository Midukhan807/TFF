...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-WqA_VULN.js
var server_WqA_VULN_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ClYzlosX.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BD6uxmJI.mjs").then((n) => n.t),
		import("./start-CV76P1jl.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_WqA_VULN_exports as t };
